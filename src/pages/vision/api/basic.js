...
function getBasic (sernum) {
  ...
  if (currentUrl.includes('fortinet')) {
    ...
    return axios.post('http://' + ipAddress + '/get-record-by-sernum/', { 'sernum': sernum, 'database': '10.167.6.165' });  // fortinet
  } else {
    ...
    return axios.post('http://' + ipAddress + '/get-record-by-sernum/', { 'sernum': sernum, 'database': '192.168.200.214' }); // Genius
  }
}
